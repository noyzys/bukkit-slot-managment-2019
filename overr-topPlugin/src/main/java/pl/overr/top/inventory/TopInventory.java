...
public class TopInventory {
    ...
    public void createYourStatsInventory(Player player){
        ...
        minedStoneInfoMeta.setLore(Collections.singletonList(ColorUtil.colorFix("&e" + user.getMinedStone())));
        ...
        playedTimeInfoMeta.setLore(Collections.singletonList(ColorUtil.colorFix("&e" + ColorUtil.timeFix(user.getTimeplayed()))));
        ...
        deathsInfoMeta.setLore(Collections.singletonList(ColorUtil.colorFix("&e" + user.getDeaths())));
    ...
    public void fillInventory(Inventory inventory, int firstRowStart, int firstRowEnd, int secondRowStart, int secondRowEnd){
        ...
        IntStream.range(firstRowStart, firstRowEnd).forEachOrdered(i -> inventory.setItem(i, new ItemStack(Material.STAINED_GLASS_PANE, 1, (short) 5)));

        IntStream.range(secondRowStart, secondRowEnd).forEachOrdered(i -> inventory.setItem(i, new ItemStack(Material.STAINED_GLASS_PANE, 1, (short) 5)));
    }
}
